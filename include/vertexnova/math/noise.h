 ...
 * @return Noise value
 */
[[nodiscard]] inline float fbm(const Vec2f& p,
                                int octaves = 6,
 ...
 */
[[nodiscard]] inline float fbm(const Vec3f& p,
                                int octaves = 6,
                                float lacunarity = 2.0f,
                                float gain = 0.5f) noexcept {
    float sum = 0.0f;
 ...
 * @return Noise value
 */
[[nodiscard]] inline float ridged(const Vec2f& p,
                                   int octaves = 6,
                                   float lacunarity = 2.0f,
                                   float gain = 0.5f,
 ...
 */
[[nodiscard]] inline float ridged(const Vec3f& p,
                                   int octaves = 6,
                                   float lacunarity = 2.0f,
                                   float gain = 0.5f,
                                   float offset = 1.0f) noexcept {
