...
## This repository (VneMath)

### Coding standards

- Enforce **.copilot/coding-guidelines.md** (naming summary) and repo **.clang-format** / **.clang-tidy**.
...
- **.clang-format** and **.clang-tidy** (repo root) are enforced in CI; focus review on design and logic. If you spot style/naming that automation might miss, flag it.

### Project layout

- Library: **src/vertexnova/math/** — Public API: **include/vertexnova/math/** — Tests: **tests/** — Examples: **examples/**
- Dependencies: **deps/internal/** (vnecommon, vnelogging), **deps/external/** (GLM, googletest).

### Build and test

- Build, tests, **clang-format**, and **clang-tidy** run in CI. Focus review on correctness, API design, and test quality rather than re-checking what CI already covers.

### Extra review focus here

- Numerical stability and units in geometry/math helpers.
- Unnecessary edits under **deps/external/** or **deps/internal/** unless the PR intentionally updates submodules.
